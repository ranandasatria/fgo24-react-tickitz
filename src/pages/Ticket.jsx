...
function Ticket() {
  ...
  useEffect(() => {
    async function fetchTicket() {
      try {
        ...
        const foundTicket = transactions.find(
    ...
    fetchTicket();
  }, [transactionId, token, currentUser, navigate]);
    ...
    return (
      <>
        ...
        <div className="flex flex-col items-center my-8 px-4 md:px-8 max-w-7xl mx-auto">
          <h3 className="text-2xl font-bold text-red-600">Loading...</h3>
        </div>
        <FooterSection />
      </>
    );
  ...
  const displayDateTime = `${ticket.showDate} at ${ticket.showTime}`;
  ...
  const displayNumTickets =
    ticket.seats.length > 0
      ...
      : '0 tickets';
  const displayTotal = ticket.totalPrice ? `$${ticket.totalPrice.toFixed(2)}` : '$0.00';
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-4">
                <div>
                  ...
                  <p className="text-base font-semibold">{ticket.movieTitle}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-base font-semibold">{ticket.location}</p>
                </div>
                <div>
